            ...
            try {
                ...
                parseObject.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            FancyToast.makeText(SocialMediaActivity.this, "Picture loaded!!", Toast.LENGTH_SHORT, FancyToast.SUCCESS, true).show();
                        } else {
                            FancyToast.makeText(SocialMediaActivity.this, "Unknown error!!", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                        }
                        dialog.dismiss();
                    }
                });
